// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NewMappingsForm.cs" company="Inspire IT Ltd">
...
namespace RyanPenfold.SolutionMaker.UI.Windows
{
    ...
    /// </summary>
    public partial class NewMappingsForm : Form
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="NewMappingsForm"/> class. 
        /// </summary>
        static NewMappingsForm()
        {
            Instance = new NewMappingsForm();
        }

        /// <summary>
        /// Prevents a default instance of the <see cref="NewMappingsForm"/> class from being created. 
        /// </summary>
        private NewMappingsForm() : this(IocContainer.Resolver.Resolve<IMappingCollection>())
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="NewMappingsForm"/> class.
        /// </summary>
        /// <param name="mappings">
        /// The set of <see cref="Mapping"/>s to process
        /// </param>
        private NewMappingsForm(IMappingCollection mappings)
        {
            if (mappings == null)
            {
        ...
        /// <summary>
        /// Gets the singleton instance of the <see cref="NewMappingsForm"/>.
        /// </summary>
        public static NewMappingsForm Instance { get; private set; }
        ...
        private void MappingsDataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var mapping = this.mappings.Items.First(m => string.Equals(m?.Id.ToString(), this.MappingsDataGridView.Rows[e.RowIndex].Cells[0].Value.ToString(), StringComparison.InvariantCultureIgnoreCase));
        ...
        private void NewMappingsForm_Load(object sender, EventArgs e)
        {
            this.MappingsDataGridView.DataSource = null;
            var formattedGroupList = new SortableBindingList<IMapping>();
            foreach (var mapping in this.mappings.Items)
            {
