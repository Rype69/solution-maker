// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CSharpUsingDirectiveCollection.cs" company="Inspire IT Ltd">
...
namespace RyanPenfold.SolutionMaker.Core
{
    ...
    /// <summary>
    /// A C# language-specific collection of imports statements.
    /// </summary>
    public class CSharpUsingDirectiveCollection : IUsingDirectiveCollection
    {
        /// <summary>
        /// A set of namespaces.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSharpUsingDirectiveCollection"/> class.
        /// </summary>
        public CSharpUsingDirectiveCollection()
        {
        ...
        /// </param>
        public CSharpUsingDirectiveCollection(IEnumerable<string> namespaces) : this()
        {
        ...
        public virtual string ToString(string indent = null)
        {
            ...
            foreach (var @namespace in this.namespaces.Where(n => n != null && (n == "System" || n.StartsWith("System."))).OrderBy(s => s))
            {
                ...
                builder.AppendWithDelimiter($"{indent}using {@namespace};", "\r\n");
